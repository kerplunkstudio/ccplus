...
export const CaptainDashboard: React.FC<CaptainDashboardProps> = ({ socket, captainState, onSessionClick }) => {
  const { captainSessionId, messages, isStreaming, isThinking, isModelThinking, toolActivity, sendMessage, archivedConversations, clearHistory, interactiveMessages, respondToInteractive, contextPct } = captainState;
